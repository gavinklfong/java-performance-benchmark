...
public class OrderBook3 {
    ...
    private final List<OrderQueue> bids = new ArrayList<>(PRICE_LEVEL_COUNT);   // BUY side, index = priceTicks - MIN
    private final List<OrderQueue> asks = new ArrayList<>(PRICE_LEVEL_COUNT);   // SELL side
